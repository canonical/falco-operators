...
At this point you should have a working Falco and Falcosidekick integration ready for use. If you
want to learn more about how to use Falco and Falcosidekick, please check out the [how-to
guides](../how-to/index) to enhance your deployment and to learn more about different use cases.
